        ...
        function rutenett(){
            ...
            <button onclick="randomHistorier()" style="font-size: 25px">klikk historie</button>
            <div style="font-weight: bolder; font-size: 15px;border: solid 3px; margin-top: 8px; height: 30px; width: 300px; background-color: lightgray;">
                Her kan egne ord settes inn:<input id="inputten" style="font-size: 25px;width: 100px; height: 25px" type="text" onchange="egneOrdKnappen(this.value)"><br><br>
            </div>
